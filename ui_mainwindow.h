...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(40, 340, 941, 331));
        QFont font1;
        ...
        le_nom_c->setGeometry(QRect(400, 40, 113, 31));
        le_numero_c = new QLineEdit(groupBox);
        le_numero_c->setObjectName(QStringLiteral("le_numero_c"));
        le_numero_c->setGeometry(QRect(400, 80, 113, 31));

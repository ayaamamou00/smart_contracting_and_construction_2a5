...
dialog_service::dialog_service(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::dialog_service)
{
    ui->setupUi(this);
}
...
void dialog_service::on_pushButton45_clicked()
{
...
void dialog_service::on_pushButton_4_clicked()
{
...
void dialog_service::on_pushButton_2_clicked()
{
...
void dialog_service::on_pushButton_3_clicked()
{
    QString nom=ui->lineEdit_7->text() ;
        ui->tableView_2->setModel(tmpservice.rechercher_serv(nom)) ;
}

void dialog_service::on_pushButton_clicked()
{
...
void dialog_service::on_pushButton_6_clicked()
{
